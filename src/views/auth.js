...
export default class AuthView {
    ...
    toggleAuthMode() {
        ...
        if (this.isSignUp) {
            updateElementText("auth-submit-text", "Create Account");
            updateElementText("toggle-text", "Already have an account? Sign in");
            showElement("display-name-field");
            getElement("display-name").required = true;
        } else {
            updateElementText("auth-submit-text", "Sign In");
            updateElementText("toggle-text", "Don't have an account? Sign up");
            hideElement("display-name-field");
            const displayNameInput = getElement("display-name");
            displayNameInput.required = false;
            setElementValue("display-name", ""); // Clear the field
        }
    ...
    setLoading(loading, button = "email") {
        if (button === "email") {
            setButtonLoading("auth-submit-btn", loading, "auth-submit-text", "auth-loading");
            ...
            const normalHTML = `
                ...
                Continue with Google
            `;
            setButtonLoadingHTML("google-signin-btn", loading, loadingHTML, normalHTML);
        }
    }
